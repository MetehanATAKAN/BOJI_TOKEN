    ...
    <section className='hero section center-content illustration-section-01'>
     <div class="container terms">
        ...
        <div class="block">
          <h2>Contact email</h2>
          <p>
            These Terms &amp; Conditions constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (“you”)
            and Rhinobob LLC. (“Company”, “we”, “us”, or “our”), concerning your
            access to and use of the https://vitainu.org/ website as well as any
            other media form, media channel, mobile website or mobile
            application related, linked, or otherwise connected thereto
            (collectively, the “platform”). You agree that by accessing the
            platform, you have read, understood, and agreed to be bound by all
            of these Terms &amp; Conditions. IF YOU DO NOT AGREE WITH ALL OF THESE
          ...
          <p>
            ...
            to make changes or modifications to these Terms &amp; Conditions at any
            time and for any reason. We will alert you about any changes by
            updating the “Last updated” date of these Terms &amp; Conditions, and
            ...
            changes in any revised Terms &amp; Conditions by your continued use of
            the platform after the date such revised Terms &amp; Conditions are
            posted.
          </p>
          <p>
        ...
        <div class="block">
          <h2>Interface</h2>
          <p>
            The platform provides access to a decentralized protocol on the Vite
            Network that allows suppliers and borrowers of digital assets to
            interact with the platform and transact using smart contracts
            (“Smart Contracts”).
          </p>
          <p>
            Using the platform may require that you pay a fee on the Vita Inu
            platform to perform a transaction. You acknowledge and agree that
            Vita Inu has no control over any transactions, the method of payment
            of any transactions, or any actual payments of transactions. You
            must ensure that you have a sufficient balance to complete any
            transaction on the platform before initiating such transaction.
          </p>
          <p>
            You acknowledge and agree that Vita Inu has no control over any
            transactions over the platform, the method of payment of any
            transactions or any actual payments of transactions. Accordingly,
            you must ensure that you have a sufficient balance of the applicable
            cryptocurrency tokens stored at your Vita Inu compatible wallet
            address (“Cryptocurrency Wallet”) to complete any transaction on the
            platform or the Vita Inu platform before initiating such
            transaction.
          </p>
          <p>
            When used on this platform, the terms “debt,” “lend,” “borrow,”
            “collateral”, “credit,” “leverage,” “bank”, “borrow”, “yield”,
            “invest” and other similar terms are not meant to be interpreted
            literally. Rather, such terms are being used to draw rough,
            fuzzy-logic analogies between the heavily automated and mostly
            deterministic operations of a decentralized-finance smart contract
            system and the discretionary performance of traditional-finance
            transactions by people. When the platform is used by users to access
            the platform and transact using Smart Contracts, there are no legal
            agreements, promises of payment, or courts of law, and therefore
            there are no debts, loans, or other traditional finance transactions
            involved.
          </p>
        </div>
        <div class="block">
          <h2>Eligibility</h2>
          <p>
            To access or use the platform, you must be able to form a legally
            binding contract with us. Accordingly, you represent that you have
            the full right, power, and authority to enter into and comply with
            the terms and conditions of this Agreement on behalf of yourself and
            any company or legal entity for which you may access or use the
            platform. You further represent that you are not a citizen,
            resident, or member of any jurisdiction or group that is subject to
            economic sanctions, or where your use of the platform would be
            illegal or otherwise violate any applicable law. You further
            represent that your access and use of the platform will fully comply
            with all applicable laws and regulations, and that you will not
        ...
        <div class="block">
          ...
          <p>
            By using the platform, you represent and warrant that: (1) you have
            the legal capacity and you agree to comply with these Terms &amp;
            Conditions; (2) you will not access the platform through automated
            or non-human means, whether through a bot, script, or otherwise; (3)
            you will not use the platform for any illegal or unauthorized
            purpose; and (4) your use of the platform will not violate any
        ...
        <div class="block">
          ...
          <ul>
            ...
            <li>
              Cyberattack. Engage in any activity that seeks to interfere with
              or compromise the integrity, security, or proper functioning of
              any computer, server, network, personal device, or other
            ...
            <li>
              Market Manipulation. Engage in any activity that violates any
        ...
        <div class="block">
          <h2>No advice</h2>
          <p>
            All information provided by the platform is for informational
            purposes only and should not be construed as professional advice. In
            particular, the content and materials available on the platform does
            not constitute any form of advice or recommendation by us, should
            not be regarded as an offer, solicitation, invitation or
            ...
            making any specific investment or other decisions. You should not
            take, or refrain from taking, any action based on any information
            contained in the platform. Before you make any financial, legal, or
            other decisions involving the platform, you should seek independent
          ...
          <p>
            Nothing included in the platform constitutes an offer or
          ...
          <p>
            Any reference to any Rate on the platform is denominated in terms of
            stablecoins or other digital assets or tokens, as applicable, not
            USD or other fiat currency. The swap rate is a forward-looking
            projection based on a good faith belief of how to reasonably project
            results over the relevant period, but such belief is subject to
            numerous assumptions, risks and uncertainties (including smart
            contract security risks and third-party actions) which could result
            in a materially different (lower or higher) token-denominated rate.
          </p>
          <p>
        ...
        <div class="block">
          ...
          <p>
            ...
            be aware these Terms &amp; Conditions no longer govern. You should
        ...
        <div class="block">
          ...
          <p>
            ...
            platform for violations of these Terms &amp; Conditions; (2) take
            appropriate legal action against anyone who, in our sole discretion,
            violates the law or these Terms &amp; Conditions, including without
            ...
            burdensome to our systems; and (5) otherwise manage the platform in
        ...
        <div class="block">
          ...
          <p>
            By accessing and using the platform, you represent that you
            ...
            blockchain-based systems are variable and may increase dramatically
            ...
            to the platform. If you borrow digital assets from the platform, you
            ...
            interact with the platform to seize your collateral in a liquidation
            event. You further acknowledge that we are not responsible for any
            of these variables or risks, do not own or control the platform, and
          ...
          <p>
            ...
            assets occurs within the decentralized platform and the blockchain.
            We cannot assist you to cancel or otherwise modify any transaction
            or transaction details. There are no warranties or guarantees that a
            transfer initiated via the platform will successfully transfer title
            or right in any digital asset.
          </p>
          <p>
            Accordingly, you understand and agree to assume full responsibility
            for all of the risks of accessing and using the platform and
        ...
        <div class="block">
          ...
          <p>
            ...
            Policy: https://vitainu.org//privacy. By using the platform, you
            agree to be bound by our Privacy Policy, which is incorporated into
            these Terms &amp; Conditions. Please be advised the platform is hosted
            in the United States. If you access the platform from any other
        ...
        <div class="block">
          ...
          <p>
            ...
            these Terms &amp; Conditions will be construed to obligate us to
        ...
        <div class="block">
          <h2>Govering law</h2>
          <p>
            These Terms &amp; Conditions and your use of the platform are governed
            by and construed in accordance with the laws of United States of
            America applicable to all interaction within the platform, without
        ...
        <div class="block">
          ...
          <p>
            ...
            arises, you must contact us by sending an email to ……. so that we
          ...
          <p>
            ...
            Agreement’s existence, validity or termination, or any other acts or
            omissions for which you may contend that we are liable, including
            (but not limited to) any claim or controversy as to arbitrability
            (“Dispute”), shall be referred to and finally resolved by
            arbitration in the state of Minnesota.
          </p>
        </div>
        <div class="block">
          <h2>Restrictions</h2>
        ...
        <div class="block">
          ...
          <p>
            ...
            use of the platform; (2) breach of these Terms &amp; Conditions; (3) any
            breach of your representations and warranties set forth in these
            Terms &amp; Conditions; (4) your violation of the rights of a third
            party, including but not limited to intellectual property rights; or
            (5) any overt harmful act toward any other user of the platform with
            whom you connected via the platform. Notwithstanding the foregoing,
        ...
        <div class="block">
          ...
          <p>
            ...
            by us on the platform or in respect to the platform constitute the
            ...
            These Terms &amp; Conditions operate to the fullest extent permissible
            ...
            these Terms &amp; Conditions is determined to be unlawful, void, or
            unenforceable, that provision or part of the provision is deemed
            severable from these Terms &amp; Conditions and does not affect the
            ...
            created between you and us as a result of these Terms &amp; Conditions
            or use of the platform. You agree that these Terms &amp; Conditions will
            ...
            electronic form of these Terms &amp; Conditions and the lack of signing
            by the parties hereto to execute these Terms &amp; Conditions.
          </p>
        </div>
        <div class="block">
          <h2>Contact us</h2>
